...
/* this class is created to display the the popular qotes in pageViewController because
 pageViewController need UIViewController to display data and scroll quotes,
 this class will be called in popularViewController in (viewQuotes) method and return textViewControllerData */
