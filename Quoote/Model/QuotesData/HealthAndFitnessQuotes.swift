...
struct HealthAndFitness {
    var catagories: [QuotesCatagory] = [
        // MARK: - Love
        QuotesCatagory(name: "Health & Fitness", image: "fitness", color: .blue, quotes: [
            "The only bad workout is the one that didn't happen.",
            "Take care of your body. It’s the only place you have to live.",
            "Fitness is not about being better than someone else. It’s about being better than you used to b.",
