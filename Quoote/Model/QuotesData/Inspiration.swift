...
//  Evlla
//
//  Created by Dambar Bista on 4/18/23.
...
struct Inspiration {
    ...
    var catagories: [QuotesCatagory] = [
        QuotesCatagory(name: "Inspiration", image: "inspiration", color: .cyan, quotes:  [
            ...
            "Believe in the power of your dreams and the magic of possibilities.",
        ...
        // MARK: - Motivation
        QuotesCatagory(name: "Motivation", image: "motivation", color: .orange, quotes: [
            "Success is not final, failure is not fatal: It is the courage to continue that counts.",
            "Believe in yourself and all that you are. Know that there is something inside you that is greater than any obstacle.",
            ...
            "Life is 10% what happens to us and 90% how we react to it.",
            "Your only limit is the amount of willingness you possess.",
