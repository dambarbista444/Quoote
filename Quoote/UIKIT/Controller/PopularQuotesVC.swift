...
class PopularQuotesVC: UIViewController {
    ...
    @IBAction func favoritePressed(_ sender: UIButton) {
        ...
        if userLikeQuotes == true {
            ...
            FavoriteManager.setHeartFillIcon(on: favoriteButton)
        } else {
            CoreDataModel.removeQuotes()
            FavoriteManager.setHeartIcon(on: favoriteButton)
        }
    }
...
extension PopularQuotesVC: UIPageViewControllerDelegate,UIPageViewControllerDataSource {
    func pageViewController(_ pageViewController: UIPageViewController, viewControllerBefore viewController: UIViewController) -> UIViewController? {
        ...
        FavoriteManager.showHeartFillIcon(on: favoriteButton, quotes: updatePopularQuotes())
